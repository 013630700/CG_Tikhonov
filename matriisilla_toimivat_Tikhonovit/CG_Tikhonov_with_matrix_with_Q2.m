...
N       = 40;
iter    = 42;% maximum number of iterations
...
% Q_2tehdään luomalla ihan tavallisen matriisin M = [alpha, beta; beta, alpha]
% ja sitten ottamalla ns. Kronecker tulon opEye:n kanssa, jolloin jokainen M:n
% alkio kerrotaan tolla opEye:llä ja siitä tulee se sama block matrix
