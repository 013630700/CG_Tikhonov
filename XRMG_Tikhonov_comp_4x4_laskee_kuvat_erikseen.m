% This code reconstrucs two (4x4 image) materials, but I think it does in the sama
% iterations, but for both images separately.?????
...
% Nyt kootaan iso A EI
%A = [c_11*A c_12*A; c_21*A c_22*A];

% Nyt kootaan A_Transpoosi EI
%A_T = [c_11*A' c_21*A'; c_12*A' c_22*A'];
%% Built measurements with inverse crime
...
axis square;
axis off;
title(['M2 CG reco2, iter=' num2str(K)]);