% Kokeilen nyt oikealla datalla matriisin kanssa, kun ilman matriisia ei
% toiminut
...
M1 = imresize(double(imread('new_HY_material_one')), [M M]);
M2 = imresize(double(imread('new_HY_material_two')), [M M]);
...
a = ('ASTRA_A_fanflat_numDetPix_280_objSize_40_angles_0_1_354');
%a=a/normest(a);
